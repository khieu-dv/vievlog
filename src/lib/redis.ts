...
const redisUrl = process.env.REDIS_URL || 'redis://:pwsefa6978@183.111.206.44:6379';
...
export async function saveMessage(message: { roomId: string; content: string; sender: string; timestamp: number }): Promise<void> {
