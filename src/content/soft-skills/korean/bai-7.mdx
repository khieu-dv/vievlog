...
```mermaid
graph TD
    A[문화생활<br/>Đời sống văn hóa] --> B[공연<br/>Công diễn]
    A --> C[전시회<br/>Triển lãm]
    A --> D[콘서트<br/>Concert]

    B --> B1[뮤지컬<br/>Musical]
    B --> B2[연극<br/>Kịch]
    B --> B3[연주회<br/>Hòa nhạc]

    C --> C1[미술 전시회<br/>Triển lãm mỹ thuật]
    C --> C2[사진 전시회<br/>Triển lãm ảnh]
    C --> C3[공예 전시회<br/>Triển lãm thủ công]
```
...
```mermaid
graph LR
    A[공연 정보를 검색하다<br/>Tìm kiếm thông tin] --> B[표를 예매하다<br/>Đặt vé]
    B --> C[티켓을 수령하다<br/>Nhận vé]
    C --> D[좌석을 찾다<br/>Tìm chỗ ngồi]
    D --> E[공연을 관람하다<br/>Xem biểu diễn]
    E --> F[감상 소감을 말하다<br/>Nói cảm nhận]
```
...
<p>Dùng để truyền đạt nội dung mệnh lệnh/câu hỏi mà người khác đã nói.</p>
</div>
...
<td className="border border-gray-300 px-4 py-2">먹다 → 먹으라고 하다<br/>읽다 → 읽냐고 하다</td>
</tr>
<tr>
...
<td className="border border-gray-300 px-4 py-2">-냐고 하다</td>
<td className="border border-gray-300 px-4 py-2">쓰다 → 쓰라고 하다<br/>가다 → 가냐고 하다</td>
</tr>
<tr>
...
<p><strong>A:</strong> 라민 씨가 뭐라고 했어요?</p>
<p><strong>B:</strong> 공연이 몇 시에 시작하냐고 했어요.</p>
<p className="text-sm text-gray-600"><em>A: Ramin nói gì? / B: Anh ấy hỏi buổi biểu diễn bắt đầu lúc mấy giờ.</em></p>
</div>

<div className="border rounded p-3">
<h5 className="font-semibold text-blue-600">Tình huống 2:</h5>
<p><strong>과장님:</strong> 내일 회의가 있으니까 모두 참석하세요.</p>
<p><strong>직원:</strong> 과장님이 내일 회의에 참석하라고 했어요.</p>
<p className="text-sm text-gray-600"><em>Trưởng phòng nói là mai có họp nên tất cả hãy tham dự.</em></p>
</div>
</div>

### 2. -만큼 (Mức độ tương đương)

<div className="border-l-4 border-orange-500 pl-4 py-2 mb-4">
<h4 className="font-semibold text-orange-700">Chức năng:</h4>
<p>Biểu thị mức độ tương đương với danh từ ở phía trước.</p>
</div>
...
<p>🎵 안젤라 씨가 <strong>가수만큼</strong> 노래를 잘해요.</p>
<p className="text-sm text-gray-600"><em>Angela hát hay như ca sĩ.</em></p>
</div>

<div className="border rounded p-3">
<h5 className="font-semibold text-purple-600">So sánh phủ định:</h5>
<p>🚗 평일은 <strong>주말만큼</strong> 시내에 사람이 많지 않다.</p>
<p className="text-sm text-gray-600"><em>Ngày thường không đông người ở trung tâm như cuối tuần.</em></p>
</div>
</div>
...
<p className="text-gray-600">Tệp âm thanh sẽ được bổ sung sau</p>
</div>
...
<p className="text-lg text-blue-600">[입짱꿴]</p>
</div>
<div className="text-center border rounded p-3">
<h5 className="font-semibold">앞좌석</h5>
<p className="text-lg text-blue-600">[압쫘석]</p>
</div>
<div className="text-center border rounded p-3">
<h5 className="font-semibold">택배</h5>
<p className="text-lg text-blue-600">[택빼]</p>
</div>
</div>
...
<p><strong>라민:</strong> 오늘 본 연극 어땠어요?</p>
<p><strong>아나이스:</strong> 저는 계속 웃다가 울다가 했어요.</p>
<p><strong>라민:</strong> 어떤 장면이 가장 인상적이었어요?</p>
<p><strong>아나이스:</strong> 제일 마지막에 배우들이 모두 같이 춤추는 장면이 기억에 남아요.</p>
</div>
</div>
...
<div>
<p><strong>공연시간:</strong> 20**년 10월 31일 오후 3시 00분</p>
<p><strong>공연장소:</strong> 한강스퀘어 뮤지컬홀</p>
</div>
<div>
<p><strong>좌석:</strong> VIP석 1층 3열 12</p>
<p><strong>예약번호:</strong> T15320505</p>
<p><strong>관람연령:</strong> 12세 이상 관람가</p>
</div>
</div>
...
<p>'문화가 있는 날'은 매월 마지막 주 수요일이다. 이날은 보통 때보다 싼 가격이나 무료로 문화생활을 할 수 있다. 그래서 부담 없이 문화생활을 즐길 수 있다.</p>

<p>지난달에 나는 그림 전시회를 보고 왔다. 나는 그림을 잘 그리지는 못하지만 보는 것을 좋아한다. 그림을 보고 있으면 기분이 좋아진다. 이번 달 '문화가 있는 날'에는 재즈(Jazz) 콘서트 티켓을 예매했다. 50% 할인을 받았다.</p>

<p>이렇게 새로운 문화생활을 하면 좋은 경험이 된다. 그리고 내 경험이 쌓이는 것만큼 한국 생활에도 점점 익숙해지고 있는 것 같다.</p>
</div>
...
<div className="border-2 border-dashed border-blue-400 p-4">
...
<p>□ 난타 (Nanta)</p>
<p>□ 사물놀이 (Samulnori)</p>
<p>□ 길거리 공연 (Biểu diễn đường phố)</p>
<p>□ 관람하다 (Xem)</p>
<p>□ 기대하다 (Mong đợi)</p>
</div>
</div>
...
<div className="space-y-1 text-sm">
<p>□ 미술 전시회 (Triển lãm mỹ thuật)</p>
<p>□ 사진 전시회 (Triển lãm ảnh)</p>
<p>□ 공예 전시회 (Triển lãm thủ công)</p>
<p>□ 작가 (Tác giả)</p>
<p>□ 갤러리 (Gallery)</p>
<p>□ 박물관 (Bảo tàng)</p>
<p>□ 예매하다 (Đặt vé)</p>
...
<p>□ 감동적이다 (Cảm động)</p>
<p>□ 유창하다 (Lưu loát)</p>
<p>□ 부담이 없다 (Không gánh nặng)</p>
<p>□ 할인을 받다 (Được giảm giá)</p>
<p>□ 경험이 쌓이다 (Tích lũy kinh nghiệm)</p>
</div>
</div>
</div>
...
<div className="border-2 border-yellow-400 p-4 rounded mb-6">
...
<p>• 먹다 → 먹으라고 하다 / 먹냐고 하다</p>
<p>• 가다 → 가라고 하다 / 가냐고 하다</p>
<p>• 부정: -지 말라고 하다</p>
<p className="text-gray-600 italic">→ Truyền đạt mệnh lệnh/câu hỏi</p>
</div>
</div>
...
<p>• 가수만큼 노래를 잘해요</p>
<p>• 주말만큼 바쁘지 않아요</p>
<p className="text-gray-600 italic">→ So sánh mức độ tương đương</p>
</div>
</div>
</div>
</div>
...
<div className="space-y-2 text-sm">
<p>□ 공연 감상 소감을 말할 수 있다</p>
<p>□ 친구와 문화생활에 대해 대화한다</p>
<p>□ 추천과 의견을 표현한다</p>
<p>□ 자연스럽게 대화를 이어간다</p>
</div>
</div>
...
<div className="border-2 border-dashed border-purple-400 p-4">
<h4 className="font-semibold text-purple-600">8과 예고: 다음에 배울 내용</h4>
<p className="mt-2">7과에서 배운 문화생활 표현들을 바탕으로, 8과에서는 더 다양한 여가 활동과 취미에 대해 학습하게 됩니다. 또한 계획과 약속을 표현하는 새로운 문법들을 익히게 될 것입니다.</p>

<div className="mt-3 grid grid-cols-2 gap-4">
<div className="text-center">
<p className="font-semibold">연결되는 주제</p>
<p className="text-sm">여가 활동, 취미생활</p>
</div>
<div className="text-center">
<p className="font-semibold">연결되는 문법</p>
<p className="text-sm">계획 표현, 약속 표현</p>
</div>
</div>
</div>
...
<div className="text-center p-4 border-t-2 border-gray-200">
<h3 className="text-xl font-bold text-gray-700">수고하셨습니다! 🎉</h3>
<p className="text-gray-600 mt-2">이제 한국의 문화생활에 대해 자신있게 이야기할 수 있을 것입니다.</p>
</div>
