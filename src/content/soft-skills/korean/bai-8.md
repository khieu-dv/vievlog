...
```mermaid
graph LR
    A[Gia vị 양념] --> B[고추장<br/>Tương ớt]
    A --> C[간장<br/>Nước tương]
    A --> D[된장<br/>Tương đậu]
    A --> E[참기름<br/>Dầu mè]
    A --> F[식초<br/>Giấm]
    A --> G[고춧가루<br/>Bột ớt]
...
```mermaid
flowchart TD
    A[요리 준비<br/>Chuẩn bị nấu ăn] --> B[씻다<br/>Rửa]
    A --> C[껍질을 벗기다<br/>Lột vỏ]
    A --> D[썰다<br/>Thái]
    A --> E[다지다<br/>Băm]

    F[요리 과정<br/>Quá trình nấu] --> G[끓이다<br/>Đun sôi]
    F --> H[튀기다<br/>Chiên]
    F --> I[찌다<br/>Hấp]
    F --> J[삶다<br/>Luộc]
    F --> K[볶다<br/>Xào]
...
<div className="border rounded-lg p-4 mb-4 bg-blue-50">
  <p className="font-semibold text-blue-800">Ý nghĩa:</p>
  <p>Biểu hiện việc làm cho người khác hoặc động vật thực hiện một hành động nào đó.</p>
</div>
...
<div className="border rounded-lg p-4 mb-4 bg-green-50">
  <p className="font-semibold text-green-800">Ý nghĩa:</p>
  <p>Biểu hiện việc làm cho người hoặc sự vật có tác động hoặc hành động nào đó.</p>
</div>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  <div className="border rounded-lg p-3">
    <p className="font-semibold text-green-700">끓다 → 끓이다</p>
    <p className="text-sm">물을 끓여요. (Đun sôi nước)</p>
  </div>
  <div className="border rounded-lg p-3">
    <p className="font-semibold text-green-700">넓다 → 넓히다</p>
    <p className="text-sm">길을 넓혀요. (Mở rộng đường)</p>
  </div>
  <div className="border rounded-lg p-3">
    <p className="font-semibold text-green-700">남다 → 남기다</p>
    <p className="text-sm">음식을 남겨요. (Để dư thức ăn)</p>
  </div>
  <div className="border rounded-lg p-3">
    <p className="font-semibold text-green-700">깨다 → 깨우다</p>
    <p className="text-sm">아이를 깨워요. (Đánh thức em bé)</p>
  </div>
</div>
...
```mermaid
sequenceDiagram
    participant H as 후엔 씨
    participant G as 고천 씨

    H->>G: 속이 좋지 않아서 어떤 음식을 먹으면 좋을까요?
    G->>H: 소화가 잘 되는 야채죽은 어때요?
    H->>G: 어떻게 만들어요?
    G->>H: 밥에 물을 넣고 끓인 다음 채소를 썰어 넣어요
    H->>G: 얼마나 끓여요?
    G->>H: 큰 채소가 익을 때까지 끓이면 돼요
```
...
<div className="border-2 border-red-300 rounded-lg p-4 mb-4">
  ...
  <div className="mb-4">
    ...
    <p className="text-sm">김치, 밥, 계란, 양파, 당근, 돼지고기, 식용유, 고춧가루, 설탕, 간장, 참기름, 깨</p>
    <p className="text-xs text-gray-600 mt-1">※ 집에 있는 재료만 넣어도 됩니다.</p>
  </div>

```mermaid
graph TD
    A[①양파, 당근 깍둑썰기] --> B[②김치 적당한 크기로 썰기]
    B --> C[③돼지고기 먼저 볶기]
    C --> D[④양파, 당근 넣고 볶기]
    D --> E[⑤양념 넣고 김치 볶기]
    E --> F[⑥밥 넣고 볶으면서 간 맞추기]
...
<div className="border rounded-lg p-4 mb-4">
  <p>Hoàn thành câu với thể sai khiến của động từ trong ngoặc:</p>
...
<div className="border rounded-lg p-4 mb-4">
  <p>Sắp xếp các bước làm 야채죽 (cháo rau) theo đúng thứ tự:</p>
...
<div className="border rounded-lg p-4 mb-4">
  <p>A: 오늘 뭘 만들어 먹을까요?</p>
  <p>B: 김치볶음밥은 어때요? ______ 쉬워요.</p>
  <p>A: 좋아요. 어떻게 ______?</p>
  <p>B: 먼저 김치와 야채를 ______ 다음에 고기를 볶아요.</p>
</div>
