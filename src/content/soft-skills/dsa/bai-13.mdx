...
<p><strong>Rust Memory Safety:</strong> Sử dụng Rc&lt;RefCell&lt;T&gt;&gt; để tránh ownership conflicts khi có multiple references đến cùng một node.</p>
<p><strong>Performance:</strong> Binary Tree thông thường không đảm bảo balanced, có thể degrade thành linked list (O(n) operations).</p>
</div>
</div>
