...
<MultiChoiceQuiz
  title="Bài tập Quan hệ nhân giao - Bài 1"
  questions={[
    {
      id: 1,
      question: "'공감대가 없고 바쁘고 해서 친해지기가 어려워요.' 여기서 '-고 해서'의 용법은?",
      options: [
        "Biểu hiện thời gian",
        "Nêu nhiều lý do cùng lúc",
        "Diễn tả điều kiện",
        "So sánh hai tình huống"
      ],
      correctAnswer: 1,
      explanation: "'-고 해서' được sử dụng để nêu nhiều lý do dẫn đến một kết quả. Ở đây là 'không có điểm chung' và 'bận rộn' là những lý do khiến khó thân thiết."
    },
    {
      id: 2,
      question: "'웃으면서 먼저 인사하고 서로 예의를 지키면 돼요.' 구조 '-으면 되다'는 무슨 뜻입니까?",
      options: [
        "Phải làm như vậy",
      ...
      correctAnswer: 2,
      explanation: "'-으면 되다' có nghĩa là 'chỉ cần...là đủ', biểu thị điều kiện tối thiểu để đạt được mục đích."
    },
    {
      id: 3,
      question: "다음 중 '대인관계'에서 어려운 점이 아닌 것은?",
      options: [
        "공감대가 없다",
        "사이가 멀어지다",
        "연락이 끊기다", 
      ...
      correctAnswer: 3,
      explanation: "'자주 연락을 주고받다' (thường xuyên liên lạc) là cách duy trì mối quan hệ tốt, không phải khó khăn trong quan hệ nhân giao."
    },
    {
      id: 4,
      question: "'선배'의 뜻은 무엇입니까?",
      options: [
        "Đồng nghiệp",
        "Cấp trên",
        "Tiền bối, anh/chị khóa trên",
        "Bạn cùng tuổi"
      ],
      correctAnswer: 2,
      explanation: "'선배' có nghĩa là tiền bối, anh/chị khóa trên - người có kinh nghiệm hơn hoặc vào trước trong học tập, công việc."
    },
    {
      id: 5,
      question: "'친구들하고 함께 시간을 보내면 될 거예요.' 이 조언의 목적은?",
      options: [
        "Giết thời gian",
      ...
      correctAnswer: 1,
      explanation: "Lời khuyên 'dành thời gian cùng nhau' nhằm mục đích tăng cường, cải thiện mối quan hệ bằng cách tạo ra những trải nghiệm chung."
    },
    {
      id: 6,
      question: "'거절하기 힘들다'의 의미는?",
      options: [
        "Dễ dàng từ chối",
      ...
      correctAnswer: 1,
      explanation: "'거절하기 힘들다' có nghĩa là 'khó khăn trong việc từ chối', thường xảy ra khi không muốn làm phật lòng người khác."
    },
    {
      id: 7,
      question: "'동창회'는 무엇입니까?",
      options: [
        "Câu lạc bộ thể thao",
        "Hội đồng môn",
        "Tập thể lao động",
      ...
      correctAnswer: 1,
      explanation: "'동창회' là hội đồng môn - tổ chức của những người cùng trường, cùng lớp để duy trì mối quan hệ và giao lưu."
    },
    {
      id: 8,
      question: "'공감을 잘해주다'는 대인관계에서 어떤 역할을 합니까?",
      options: [
        "Tạo ra xung đột",
        "Thể hiện sự đồng cảm, hiểu biết",
        "Phê bình người khác",
        "Tránh giao tiếp"
      ],
      correctAnswer: 1,
      explanation: "'공감을 잘해주다' (thể hiện sự đồng cảm tốt) giúp người khác cảm thấy được hiểu và chia sẻ, tăng cường mối quan hệ."
    },
    {
      id: 9,
      question: "'의견을 솔직하게 말하다'에서 '솔직하게'의 뜻은?",
      options: [
        "Một cách thận trọng",
        "Một cách gián tiếp",
      ...
      correctAnswer: 2,
      explanation: "'솔직하게' có nghĩa là một cách thẳng thắn, chân thành, không che giấu suy nghĩ thật của mình."
    },
    {
      id: 10,
      question: "'동호회'의 특징이 아닌 것은?",
      options: [
        "같은 취미를 가진 사람들",
        "정기적인 모임",
        "반드시 같은 학교 출신",
      ...
      correctAnswer: 2,
      explanation: "'동호회' (câu lạc bộ sở thích) không yêu cầu phải cùng trường. Điều quan trọng là có cùng sở thích, không phân biệt xuất thân học tập."
    }
  ]}
/>
