...
<div className="bg-gradient-to-r from-blue-50 to-indigo-100 p-6 rounded-lg border-l-4 border-blue-500 mb-6">
  ...
  <p className="text-gray-700 text-lg">Một hành trình 18 bài học để trở thành Go Developer chuyên nghiệp</p>
</div>
...
<div className="bg-green-50 p-4 rounded-lg border border-green-200 my-4">
  ...
  <ul className="text-green-700 space-y-1">
    <li>• Phát triển ứng dụng backend với Go</li>
    <li>• Xây dựng REST API và microservices</li>
    <li>• Làm việc hiệu quả với concurrent programming</li>
    <li>• Deploy ứng dụng Go lên production</li>
  </ul>
</div>
...
<div className="grid md:grid-cols-2 gap-4 my-4">
  <div className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-400">
    ...
    <ul className="text-yellow-700 space-y-1 text-sm">
      <li>• Kinh nghiệm lập trình cơ bản</li>
      <li>• Hiểu biết về command line</li>
      <li>• Khái niệm về git/version control</li>
    </ul>
  </div>
  <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-400">
    <h4 className="text-blue-800 font-semibold mb-2">💡 Khuyến khích</h4>
    <ul className="text-blue-700 space-y-1 text-sm">
      <li>• Một ngôn ngữ lập trình bất kỳ</li>
      <li>• Hiểu biết về web development</li>
      <li>• Kinh nghiệm với databases</li>
    </ul>
  </div>
</div>
...
<div className="bg-gray-50 p-6 rounded-lg my-4">
  <div className="grid md:grid-cols-3 gap-4">
    <div className="text-center">
      ...
      <p className="text-sm text-gray-600">Không bỏ qua bài nào, xây dựng nền tảng vững chắc</p>
    </div>
    <div className="text-center">
      <div className="text-3xl mb-2">💻</div>
      <h4 className="font-semibold text-gray-800">Practice by coding</h4>
      <p className="text-sm text-gray-600">Code theo mọi ví dụ, không chỉ đọc</p>
    </div>
    <div className="text-center">
      <div className="text-3xl mb-2">🔄</div>
      <h4 className="font-semibold text-gray-800">Ôn tập thường xuyên</h4>
      <p className="text-sm text-gray-600">Review kiến thức cũ khi học bài mới</p>
    </div>
  </div>
</div>
