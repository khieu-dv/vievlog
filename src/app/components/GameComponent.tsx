            ...
            {isMobile && (
                <>
                    ...
                    <div className="fixed bottom-20 left-6 z-50">
                        ...
                        <div className="text-white text-xs text-center mt-2 opacity-70">MOVE</div>
                    </div>
                    ...
                    <div className="fixed bottom-20 right-6 z-50 flex flex-col space-y-3">
                        {/* Action Button */}
                        <button
                            className="w-16 h-16 bg-green-600 hover:bg-green-700 active:bg-green-800 text-white rounded-full font-bold text-sm shadow-lg flex items-center justify-center select-none"
                            onTouchStart={(e) => {
                                e.preventDefault();
                                handleActionPress(' ');
                            }}
                        ...
                        {/* Debug Button */}
                        <button
                            className="w-12 h-12 bg-purple-600 hover:bg-purple-700 active:bg-purple-800 text-white rounded-full font-bold text-xs shadow-lg flex items-center justify-center select-none"
                            onTouchStart={(e) => {
                                e.preventDefault();
                                handleActionPress('d');
                            }}
                        ...
                        <div className="text-white text-xs text-center opacity-70">ACTION</div>
                    </div>
                </>
            )}
        </div>
