          ...
          <div className="bg-card sm:rounded-md sm:border hover:border-muted-foreground/20 transition-colors">
            <div className="flex flex-col sm:flex-row">
              ...
              <div className="flex-1 p-3 sm:p-4">
                ...
                {/* Post Title */}
                <h1 className="text-lg sm:text-xl font-medium text-foreground mb-3 line-clamp-3">
                  {post.title}
                </h1>
                ...
                {/* Post Cover Image */}
                {post.coverImage && (
                  <div className="relative w-full h-64 sm:h-80 md:h-96 mb-4 rounded overflow-hidden">
                    <Image
                      src={post.coverImage}
                      alt={post.title}
                      fill
